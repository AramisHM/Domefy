...
#include <Application/Components/StereosHoloAnimator/StereoHoloAnimator.h>
...
StereoHoloAnimatior::StereoHoloAnimatior(Context *context)
    : LogicComponent(context), moveSpeed_(0.0f), rotationSpeed_(0.0f) {
...
void StereoHoloAnimatior::SetParameters(slideElement se, float *pPitch,
                                        float *pYaw, float *pRadius,
