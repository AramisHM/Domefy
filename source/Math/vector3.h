...
//  Example of use Vec3<double> vector1(1, 2, 3);
...
template <class T> class Vec3
{
    ...
    public:
		...
		// Method to convert a char array string to a vector3, example "0.000000, 0.000000, 0.000000", WARNING, this function have nbo security CHECKS yet, use with caution
        void atovec3(char *array_Vector)
        {
			char *delimit = ",";
