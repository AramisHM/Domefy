...
class Fpmed : ScriptObject
{
    ...
    void CreateScene()
    {
        ...
        videoNode.position = Vector3(0.0f, 5.0f, 1.2f);
        videoNode.scale = Vector3(2.2f, 1.2f, 0.02f);
        videoNode.rotation = Quaternion(0.0f, -180.0f, 0.0f);
        videoComp = videoNode.CreateComponent("TVComponent");
        videoComp.OpenFileName("./Data/Videos/video10.ogv");
